...
subparser_task.add_argument("-n", "-new", dest="new_task", 
                    help="description of task", action="store", default=argparse.SUPPRESS)

# Subparser list all task
subparser_task_list = subparser.add_parser("list", help="Show all the task running")
subparser_task_list.add_argument("-s", "-show", action="store_true", dest="show")
